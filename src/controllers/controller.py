...
def login():
    ...
    try:
        ...
        error = f"Ocurrió un error en login: {e}"
...
def logout():
    ...
    try:
        ...
        error = f"Ocurrió un error en logout: {e}"
        return render_template('error.html', error=error)
...
def finanzas(fechaIni, fechaFin, agrupar_por):
    try:
        ...
        error = f"Ocurrió un error en finanzas: {e}"
        return render_template('error.html', error=error)
    finally:
        session.close()
...
def index():
    try:
        ...
        error = f"Ocurrió un error en index: {e}"
        return render_template('error.html', error=error)
    finally:
        session.close()
...
def productos(msg):
    try:
        ...
        error = f"Ocurrió un error en productos: {e}"
        return render_template('error.html', error=error)
    finally:
        session.close()
...
def consultar_productos():
    try:
        ...
        error = f"Ocurrió un error en consultar_productos: {e}"
        return render_template('error.html', error=error)
...
def registrar_productos():
    try:
        ...
        error = f"Ocurrió un error en registrar_productos: {e}"
        return render_template('error.html', error=error)
    finally:
        session.close()
...
def editar_productos(idProducto):
    try:
        ...
        error = f"Ocurrió un error en editar_productos: {e}"
        return render_template('error.html', error=error)
    finally:
        session.close()
...
def modificar_productos(idProducto):
    try:
        ...
        error = f"Ocurrió un error en modificar_productos: {e}"
        return render_template('error.html', error=error)
    finally:
        session.close()
...
def eliminar_productos(idProducto):
    try:
        ...
        error = f"Ocurrió un error en eliminar_productos: {e}"
        return render_template('error.html', error=error)
    finally:
        session.close()